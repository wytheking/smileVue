<template>
  <div>
    ...
    <!--swipwer area-->
    <!--<swiperDefault :slide="bannerPicArray" />-->
...
export default {
  ...
  data () {
    return {
      ...
      msg: 'Shopping Mall',
      locationIcon: require('../../assets/images/location.png'), // 定位图片
      bannerPicArray: [ // 轮播图片
        // {image: 'https://j-image.missfresh.cn/img_20190311114444266.png'},
        // {image: 'https://j-image.missfresh.cn/img_20190403184328560.png'},
        // {image: 'https://j-image.missfresh.cn/img_20181228104244736.png'}
      ],
      category: [],
      adBanner: '',
      recommendGoods: [],
